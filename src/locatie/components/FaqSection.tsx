    ...
    <section id="faq" className="py-28 px-6 md:px-10 scroll-mt-24">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-14">
          <p className="uppercase tracking-[0.3em] text-gold-light text-base mb-4">Goed om te weten</p>
          <h2 className="font-heading text-4xl md:text-5xl tracking-[-0.02em] mb-6 text-balance">
            Veelgestelde vragen
          </h2>
          <p className="text-prose text-xl leading-[1.7] max-w-xl mx-auto text-pretty">
        ...
        <ul className="flex flex-col gap-3" aria-hidden="true">
          {PLACEHOLDER_QUESTIONS.map((q) => (
            <li
              key={q}
              className="flex items-center justify-between gap-4 rounded-xl border border-white/8 bg-surface-elevated/40 px-6 py-5 opacity-60 select-none"
            >
              <span className="font-heading text-lg text-white/70">{q}</span>
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
