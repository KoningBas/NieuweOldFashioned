        ...
        {packages.map((pkg) => {
          ...
          return (
            <button
              ...
              className={`text-left rounded-xl p-6 border transition-transform duration-200 hover:-translate-y-0.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-gold-light focus-visible:outline-offset-2 ${
      ...
      <div className="flex flex-wrap gap-3 mb-10">
        {EVENT_TYPES.map((type) => (
          <button
            ...
            className={`rounded-full px-5 py-2.5 border text-sm transition-transform duration-200 hover:-translate-y-0.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-gold-light focus-visible:outline-offset-2 ${
