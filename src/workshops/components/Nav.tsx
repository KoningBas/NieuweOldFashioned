...
const NAV_LINKS = [
  ...
  { href: '/workshops/', label: 'Workshops', active: true },
  { href: '/locatie/', label: 'Op Locatie', active: false },
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-end">
            <a href="#reserveren" className="btn-primary rounded-full px-3 py-2 text-sm sm:px-5 sm:py-2.5 sm:text-base font-body font-semibold no-underline whitespace-nowrap">
              Boek Workshop
            </a>
          </div>
        </div>
      ...
      <div id="mobile-menu" className={`fixed inset-0 z-40 bg-black/95 backdrop-blur-sm flex flex-col pt-20 px-6 xl:hidden ${open ? 'open' : ''}`}>
        ...
        <a href="#reserveren" onClick={() => setOpen(false)} className="btn-primary mt-8 rounded-full px-8 py-4 text-center font-heading text-xl no-underline">
          Boek Workshop
        </a>
      </div>
    </>
